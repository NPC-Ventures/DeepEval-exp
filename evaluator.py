...
class Evaluator:
    def __init__(self):
        ...
        self.base_url=os.getenv("LOCAL_MODEL_BASE_URL") if self.exec_env == "local" else None

    def build_metric(self, name, criteria, evaluation_params, threshold=0.5, model=None):
